...
|:---|---|---|---|---|
|🐍[Snopes Raw Scraped Data & Fake-News Classifier](https://github.com/dyuthiii/Snopes.git)| Web-Scraping, Data Analyses, Machine Learning| I web-scraped the Snopes website (a fact-checking news source) from January to July 2025. I used this data to build [Tableau Visualizations](#visualizations) about  news catergory they the rating of misinformation given by snopes. Additionally, I performed some basic data analyses and built a [logistic regression](https://github.com/dyuthiii/Snopes/blob/5a522156d05cd4c2509352078592e013a960da5b/code/Logistic%20Regression%20Snopes%20Rating.ipynb) model to effectively categorize news articles as real or fake.| Python| pandas, Beautiful Soup, scikit-learn, re|
